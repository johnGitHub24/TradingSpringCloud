...
| **本文件** | 開發計畫、能力對照、DoD |
| `API規格書.md` | 端點契約 |
| `docs/專案引導教學.html` | 互動架構（建議先看） |
| `docs/初學者學習說明書.md` | 3 天入門 |
| `docs/架構學習導引.md` | Spring Cloud 概念對照 |
| `docs/功能流程說明.md` | Mermaid 流程 |
| `docs/測試與CI.md` | Case ID |
