...
class StartupInfoLoggerTest {
    ...
    void enabled_printsBannerWithoutProbe() {
        ...
        when(env.getProperty("startup.info.project-name", "TradingSpringCloud Gateway")).thenReturn("TradingSpringCloud Gateway");
        ...
        assertThat(out).contains("TradingSpringCloud Gateway 後端已啟動");
