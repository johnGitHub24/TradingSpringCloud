...
class StartupInfoLoggerTest {
    ...
    void enabled_printsBannerWithoutProbe() {
        ...
        when(env.getProperty("startup.info.project-name", "TradingSpringCloud Loop")).thenReturn("TradingSpringCloud Loop");
        ...
        assertThat(out).contains("TradingSpringCloud Loop 後端已啟動");
        assertThat(out).contains("http://localhost:8081/actuator/health");
